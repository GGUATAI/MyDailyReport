...
9.4
日报第八十四天：队内电控框架除部分未理解，初步打算不更改例如裁判系统之类的通信代码，新建英雄的框架，首先添加算法部分，更改pid的结构体成员组成以及部分pid计算代码

9.5
日报第八十五天：完善RM新生培训内容，制作第一讲部分PPT

9.6
日报第八十六天：确定RM新生培训内容，以及概括性的培训计划表。继续给英雄框架依据普通步兵框架新增协议层代码
